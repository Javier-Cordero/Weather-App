  ...
  return (
    <div className="bg-[#100E1D] md:w-[981px] md:h-screen sm:w-[375px] sm:h-[1718px]">
            ...
            <div className="absolute lg:w-[120px] lg:h-[140px] lg:top-[40px] lg:left-[490px] bg-[#1E213A] text-center">
                {error && <p className='text-red-500 text-[6px]'>{error}</p>}
                {forecast.map((day, index) => (
                    <div key={index} className='flex flex-wrap'>
                        <span className='absolute lg:top-2 mx-auto lg:left-2 lg:right-2'>Tomorrow</span>
                        <img className='absolute lg:w-[44px] lg:h-[49px] lg:top-[40px] lg:left-[30px]' src={Thunderstorm} alt='icono del clima' />
                        <div className='absolute lg:w-100px mx-auto lg:left-2 lg:right-2 lg:top-[105px] flex justify-around'>
                            <span className='lg:text-[12px] font-medium'>max</span>
                            <span className='lg:text-[12px] font-medium'>min</span>
                        </div>
                    </div>
                ))}
            </div>
